...
func (_m *MedRepo) Update(medicalReport *domain.MedicalReport) error {
	ret := _m.Called(medicalReport)
...
func (_c *MedRepo_Update_Call) Return(_a0 error) *MedRepo_Update_Call {
	_c.Call.Return(_a0)
	return _c
}

func (_c *MedRepo_Update_Call) RunAndReturn(run func(*domain.MedicalReport) error) *MedRepo_Update_Call {
	_c.Call.Return(run)
	return _c
}
