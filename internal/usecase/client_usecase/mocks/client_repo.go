...
func (_m *ClientRepo) Create(client *domain.Client) error {
...
func (_c *ClientRepo_Create_Call) Return(_a0 error) *ClientRepo_Create_Call {
	_c.Call.Return(_a0)
	return _c
}

func (_c *ClientRepo_Create_Call) RunAndReturn(run func(*domain.Client) error) *ClientRepo_Create_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_m *ClientRepo) Update(client *domain.Client) error {
	ret := _m.Called(client)
...
func (_c *ClientRepo_Update_Call) Return(_a0 error) *ClientRepo_Update_Call {
	_c.Call.Return(_a0)
	return _c
}

func (_c *ClientRepo_Update_Call) RunAndReturn(run func(*domain.Client) error) *ClientRepo_Update_Call {
	_c.Call.Return(run)
	return _c
}
